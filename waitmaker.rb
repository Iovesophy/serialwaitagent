...
puts "TranceWaitMaker. このプログラムはあなたのステータス設定ファイルを自動生成できます. happy coding!! by Iovesophy."
...
File.open("hinagata.py","w") do |code|
	...
	code.puts "# transwaitprocessor made by Iovesophy --"
	code.puts ""
	code.puts "import serial"
	code.puts "import time"
	code.puts ""
	code.puts "class TransWait():"
	code.puts ""
